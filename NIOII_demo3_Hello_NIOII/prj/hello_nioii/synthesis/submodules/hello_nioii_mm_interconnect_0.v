// hello_nioii_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module hello_nioii_mm_interconnect_0 (
	...
	hello_nioii_mm_interconnect_0_router router (
	...
	hello_nioii_mm_interconnect_0_router_001 router_001 (
	...
	hello_nioii_mm_interconnect_0_router_002 router_002 (
	...
	hello_nioii_mm_interconnect_0_router_002 router_003 (
	...
	hello_nioii_mm_interconnect_0_router_004 router_004 (
	...
	hello_nioii_mm_interconnect_0_router_004 router_005 (
	...
	hello_nioii_mm_interconnect_0_router_002 router_006 (
	...
	hello_nioii_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_clk_clk),                                     //        clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset),         //  clk_reset.reset
	...
	hello_nioii_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_clk_clk),                                            //        clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	hello_nioii_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_clk_clk),                             //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_nioii_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_clk_clk),                             //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_nioii_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_clk_clk),                             //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_nioii_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_clk_clk),                             //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_nioii_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_clk_clk),                              //       clk.clk
		.reset               (uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_nioii_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_nioii_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_nioii_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_nioii_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (clk_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_nioii_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_clk_clk),                              //       clk.clk
		.reset              (uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_nioii_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_clk_clk),                             //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_nioii_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_clk_clk),                             //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_nioii_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
