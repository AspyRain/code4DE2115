...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../hello_nioii.sopcinfo
...
# Design Name 
# setting SOPC_NAME is hello_nioii
SOPC_NAME := hello_nioii
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1715701359
SOPC_SYSID_FLAG += --timestamp=1715701359
ELF_PATCH_FLAG  += --timestamp 1715701359
